...
fun manipulateString(str: String, int: Int): String {
    ...
    return if (digits.isNotEmpty()) {
        // Jika mengandung digit, maka extract kemudian kalikan dengan nilai dari int
        val multipliedValue = digits.toInt() * int
        str.replace(digits, multipliedValue.toString())
    } else {
        // jika tidak mengandung digit, maka langsung saja gabungkan
        str + int
    }
}
