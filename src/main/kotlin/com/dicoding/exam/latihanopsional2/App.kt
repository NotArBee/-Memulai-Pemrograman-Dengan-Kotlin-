...
fun minAndMax(number: Int): Int {
    // Mengubah terlebih dahulu angka menjadi string agar masing2 angka dapat diakses
    val numberToString = number.toString()
    // Membuat collection baru dengan map, kemudian mengubah nya menjadi string lalu ke integer
    val newCollections = numberToString.map { it.toString().toInt() }
    // Nilai terbesar
    val maxNumber = newCollections.maxOrNull() ?: 0
    // Nilai Terkecil
    val minNumber = newCollections.minOrNull() ?: 0
